		...
		foreach($vpb_domain_servers as $vpb_domain_servers_ext => $vpb_domain_whois)
		{
			...
			if($vpb_socket = fsockopen($vpb_domain_whois[0], 43))
			{
...

				{
					$available .= '
	  				<tr>
	  					<td style = "width: 1em; padding-top: 0.8em; color: #11aaea; font-size: 1.5em;">
	  					<i class="fa fa-chevron-right" aria-hidden="true"></i></td>
					  	<td><h4>www.' . $vpb_cleaned_domain_name_to_search. '<b>' . 
									$vpb_domain_servers_ext . '</b></h4></td>
	  					<td class="available"><span>Available</span></td>
	  				</tr> ';
				}
				else
				{
					$taken .= '
	  				<tr>
					  	...
					  	<td><h4>www.' . $vpb_cleaned_domain_name_to_search . '<b>' 
					  			.$vpb_domain_servers_ext . '</b></h4></td>
	  					<td class="taken"><span>Taken</span></td>
	  				</tr> ';
				}
...
<body>
	...
	<section class='container'>
		<article class="row">
			<div class="col-md-6">
				<table class="table table-border"><?php echo $taken; ?></table>
			</div>	
			<div class="col-md-6">
				<table class="table table-border"><?php echo $available; ?></table>
			</div>	
		</article>
	</section>
</body>
