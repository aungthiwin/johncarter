...
{	
	...
	else
	{
		...
		$.ajax({  
			...
			beforeSend: function() 
			{
				$("#vpb_search_status").html('<br clear="all"><br clear="all"><font style="font-family:Verdana, Geneva, sans-serif; font-size:12px;">Please wait</font> <img src="dist/domain/images/loadings.gif" align="absmiddle" alt="Loading..."><br clear="all"><br clear="all">');
			},  
